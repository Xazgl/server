        ...
        <>
            <div className="bannerZafira">
             ...
             <div className='descriptionZafira'>
                 <div className='text'><h1 className='y'>НАДЕЖНЫЙ, УЛЬТРАПРАКТИЧНЫЙ И УНИВЕРСАЛЬНЫЙ</h1></div>
             </div>
              ...
              <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                    <li>Полная масса 2150 кг</li>
                     <li>Длина кузова 4380 мм</li>
                     <li>Антиблокировочная тормозная система (ABS)</li>
                     <li>Cистема помощи  при начале движения на склоне (Hill assist)</li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li>Полная масса 2190 кг</li>
                     <li>Правая боковая неостеклённая сдвижная дверь для версии XL</li>
                     <li>Длина кузова 4628 мм</li>
                     <li>Cистема помощи  при начале движения на склоне (Hill assist)</li>
                   </ul>
