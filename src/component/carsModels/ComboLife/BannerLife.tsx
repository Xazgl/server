        ...
        <>
            <div className="bannerZafira">
             ...
             <div className='descriptionZafira'>
                 <div className='text'><h1 className='y'><span className='span1'>Opel Combo Life — проверенный помощник в бизнесе и верный друг семьи.</span></h1></div>
             </div>
               ...
               <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                    <li><span className='span'>- Бензиновый двигатель 1.6 (115)</span></li>
                     <li><span className='span'>- Механическая,пятиступенчатая коробка передач</span></li>
                     <li><span className='span'>- Объем багажного отделения от 675 л</span></li>
                     <li><span className='span'>- Круиз-контроль</span></li>
                     <li><span className='span'>- Электрообогрев лобового стекла</span></li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- Бензиновый двигатель 1.6 (115)</span></li>
                     <li><span className='span'>- Гидромеханическая автоматическая,коробка передач</span></li>
                     <li><span className='span'>- Объем багажного отделения от 675 л</span></li>
                     <li><span className='span'>- Круиз-контроль</span></li>
                     <li><span className='span'>- Электрообогрев лобового стекла</span></li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- Дизельный двигатель 1.6 (90)</span></li>
                     <li><span className='span'>- Механическая, пятиступенчатая коробка передач</span></li>
                     <li><span className='span'>- Объем багажного отделения от 675 л</span></li>
                     <li><span className='span'>- Круиз-контроль</span></li>
                     <li><span className='span'>- Электрообогрев лобового стекла</span></li>
