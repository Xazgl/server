        ...
        <>
            <div className="bannerZafira">
             ...
             <div className='descriptionZafira'>
                 <div className='text'><h1 className='y'><span className='span1'>Многогранность, вызывающая восхищение.Crossland — это кроссовер, подходящий для повседневного использования, и обладающий великолепным дизайном, привлекающим внимание везде, куда бы вы ни отправились.</span></h1></div>
             </div>
               ...
               <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                    <li><span className='span'>- 6 подушек безопасности</span></li>
                     <li><span className='span'>- Фронтальная оптика с LED лампами </span></li>
                     <li><span className='span'>- Рулевое колесо с обогревом</span></li>
                     <li><span className='span'>- Круиз-контроль</span></li>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- "16" Легкосплавные диски</span></li>
                     <li><span className='span'>- Противотуманные LED фары</span></li>
                     <li><span className='span'>- Камера заднего вида</span></li>
                     <li><span className='span'>- Рейлинги на крыше</span></li>
                     <li><span className='span'>- Лобовое стекло с электрообогревом</span></li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- "17" легкосплавные диски</span></li>
                     <li><span className='span'>- Передние анатомические сидения</span></li>
                     <li><span className='span'>- Park Assist</span></li>
                     <li><span className='span'>- Адаптивное головное освещение</span></li>
                     <li><span className='span'>- Контрастная крыша "Diamond Black"</span></li>
                   </ul>
