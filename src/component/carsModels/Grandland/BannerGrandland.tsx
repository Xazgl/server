...
import banner from '/public/images/grandland.webp'
import miniBanner from '/public/images/grandl.webp'
import zafira from '/public/images/models/5.webp';
        ...
        <>
            <div className="bannerZafira">
             ...
             <div className='descriptionZafira'>
                 <div className='text'><h1 className='y'><span className='span1'>Кроссовер Grandland X - чистокровный Opel, созданный принять вызовы дороги и дать вам вновь почувствовать азарт.</span></h1></div>
             </div>
               ...
               <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                    <li><span className='span'>- Пакет "Winter Options" </span></li>
                     <li><span className='span'>- Круиз-контроль </span></li>
                     <li><span className='span'>- Светодиодные фары рефлекторного типа</span></li>
                     <li><span className='span'>- Мультимедийная система Navi </span></li>
                     <li><span className='span'>- Легкосплавные колесные диски R17 </span></li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- Пакет "Winter Options"</span></li>
                     <li><span className='span'>- Спортивные сиденья</span></li>
                     <li><span className='span'>- Система интеллектуального привода</span></li>
                     <li><span className='span'>- Светодиодные фары проекционного типа</span></li>
                     <li><span className='span'>- Легкосплавные колесные диски R18</span></li>
                   </ul>
