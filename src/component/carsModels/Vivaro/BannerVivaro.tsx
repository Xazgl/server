        ...
        <>
            <div className="bannerZafira">
             ...
             <div className='descriptionZafira'>
                 <div className='text'><h1 className='y'><span className='span1'>Эффективное решение ваших профессиональных задач.</span></h1></div>
             </div>
               ...
               <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                    <li><span className='span'>- Дизельный двигатель 2.0 (150)</span></li>
                     <li><span className='span'>- Механическая коробка передач</span></li>
                     <li><span className='span'>- Полная масса 2495</span></li>
                     <li><span className='span'>- Длинна кузова 4959мм</span></li>
                   </ul>
                ...
                <div className='content'>
                 ...
                 <div className="complUl">
                   <ul>
                     <li><span className='span'>- Дизельный двигатель 2.0 (150)</span></li>
                     <li><span className='span'>- Механическаякоробка передач</span></li>
                     <li><span className='span'>- Полная масса 3106</span></li>
                     <li><span className='span'>- Длинна кузова 5309мм</span></li>
                   </ul>
